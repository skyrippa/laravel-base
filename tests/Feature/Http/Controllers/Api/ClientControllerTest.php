...
class ClientControllerTest extends TestCase
{
    ...
    public function canReturnPaginatedCollection()
    {
        ...
        $partner1 = Client::first();
        $query    = $query . "&search[]=id,$partner1->id";

        $partner2 = Client::latest('id')->first();
        ...
        Client::factory()->forUser()->create();

        $email = Client::first()->user->email;
        ...
        // various filters
        $date  = Client::first()->created_at->format('Y-m-d');
